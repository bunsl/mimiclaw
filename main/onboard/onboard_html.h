...
"</select>"
"<label>Feishu API Key Override</label>"
"<input id='feishu_api_key' type='password' placeholder='Use default API key'>"
"<label>Feishu Model Override</label>"
"<input id='feishu_model' placeholder='Use default model'>"
"<label>Feishu Provider Override</label>"
"<select id='feishu_provider'>"
...
"<option value='volcengine'>Volcengine (Ark)</option>"
"</select>"
"<label>WebSocket API Key Override</label>"
"<input id='websocket_api_key' type='password' placeholder='Use default API key'>"
"<label>WebSocket Model Override</label>"
"<input id='websocket_model' placeholder='Use default model'>"
"<label>WebSocket Provider Override</label>"
"<select id='websocket_provider'>"
"<option value=''>Use default provider</option>"
"<option value='anthropic'>Anthropic</option>"
"<option value='openai'>OpenAI</option>"
"<option value='minimax'>MiniMax</option>"
"<option value='volcengine'>Volcengine (Ark)</option>"
"</select>"
"<label>CLI API Key Override</label>"
"<input id='cli_api_key' type='password' placeholder='Use default API key'>"
"<label>CLI Model Override</label>"
"<input id='cli_model' placeholder='Use default model'>"
"<label>CLI Provider Override</label>"
"<select id='cli_provider'>"
"<option value=''>Use default provider</option>"
"<option value='anthropic'>Anthropic</option>"
"<option value='openai'>OpenAI</option>"
"<option value='minimax'>MiniMax</option>"
"<option value='volcengine'>Volcengine (Ark)</option>"
"</select>"
"<label>System API Key Override</label>"
"<input id='system_api_key' type='password' placeholder='Use default API key'>"
"<label>System Model Override</label>"
"<input id='system_model' placeholder='Use default model'>"
"<label>System Provider Override</label>"
"<select id='system_provider'>"
"<option value=''>Use default provider</option>"
"<option value='anthropic'>Anthropic</option>"
"<option value='openai'>OpenAI</option>"
"<option value='minimax'>MiniMax</option>"
...
/* Display section */
"<div class='card collapsed' id='sec-display'>"
"<div class='card-hdr' onclick='toggle(this)'>Display</div>"
"<div class='card-body'>"
"<label>Theme</label>"
...
"</select>"
"<label>Locale</label>"
"<input id='display_locale' placeholder='zh-CN'>"
"</div></div>"

/* Voice section */
"<div class='card collapsed' id='sec-voice'>"
"<div class='card-hdr' onclick='toggle(this)'>Voice</div>"
"<div class='card-body'>"
"<label>App ID</label>"
"<input id='voice_appid' placeholder='Voice appid'>"
"<label>Access Token</label>"
"<input id='voice_access_token' type='password' placeholder='Access token'>"
"<label>Cluster</label>"
"<input id='voice_cluster' placeholder='volc cluster'>"
"<label>WebSocket URL</label>"
"<input id='voice_ws_url' placeholder='wss://...'>"
"<label>Language</label>"
"<input id='voice_language' placeholder='zh-CN'>"
"<label>Continuous Mode</label>"
"<select id='voice_continuous_mode'>"
...
"'feishu_api_key','feishu_model','feishu_provider',"
"'websocket_api_key','websocket_model','websocket_provider',"
"'cli_api_key','cli_model','cli_provider',"
"'system_api_key','system_model','system_provider',"
"'feishu_app_id','feishu_app_secret','proxy_host','proxy_port','proxy_type','search_key','tavily_key',"
"'display_theme','display_locale','voice_appid','voice_access_token','voice_cluster','voice_ws_url',"
"'voice_language','voice_continuous_mode'];"
"var data={};"
